...
echo -e "	[+]$red https://www.youtube.com/channel/UCgeKs8tf5UI6b42NRlZ_aUQ?view_as=subscriber$nc [+]"
echo -e "	[+] 		       $red Greetz To All Pentesters$nc          		     [+]"
echo -e "	[+]$red Special Greetz To$nc :$green {thelinuxchoice ,محمد لعبؤطه, }$nc                  [+]"
echo ""
